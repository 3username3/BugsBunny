/*Precompiled headers are files that are compiled once and stored in a binary format. 
This makes them compile faster. They are mainly used for two reasons:
	* they reduce compilation time
	* they are more convenient, as not every include has to be added manually to every cpp file
